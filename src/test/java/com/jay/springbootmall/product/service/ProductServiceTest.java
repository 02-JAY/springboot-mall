...
public class ProductServiceTest {
    ...
    void getBotRecommendations_shouldFilterDeletedAndSortByPromoAndLimitToOne() {
        ...
        deletedProduct.setIsPromo(true);
        ...
        // =================================================================
        // 🎯 修正：第二個參數改傳入真正的 Enum 型態 ProductCategory.DEHUMIDIFIER
        List<Product> result = productService.getBotRecommendations("除濕機", ProductCategory.DEHUMIDIFIER);
        ...
        // 🎯 修正：如果你的 isPromo 欄位在 Entity 裡是 Boolean，斷言要改用 assertTrue 或比較 boolean
        assertEquals(true, recommended.getIsPromo(), "應該優先推薦正在促銷的商品");
